...
{
    [RouteArea("Admin")]
    [RoutePrefix("member_biodata")]
    public class Member_BiodataController : AlertController
    {

        IBiodataRepositoryService _biodataservice;
        public Member_BiodataController(IBiodataRepositoryService biodataservice)
        {
        ...
        public ActionResult saveBiodata(HttpPostedFileBase pics, Member_BiodataVM data)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (tblbiodata == null)
                    {
                        ...
                        return RedirectToAction("memberbiodatas");
                    }
            ...
            return RedirectToAction("CreateBiodata");
        }

        //[Route("memberbiodatas")]
        //public ActionResult memberbiodatas()
        //{
        ...
        public ActionResult editmemberbiodata(int? id)
        {
            if (id == null)
            {
                Information("Invalid member");
                RedirectToAction("editmemberbiodata", true);
            }
            ...
            if (findMember == null)
            {
                ...
                RedirectToAction("editmemberbiodata");
            }
        ...
        {
            var isBiodataDelete = _biodataservice.DeleteMemberBiodata(id);
            ...
            return RedirectToAction("memberbiodatas", "Member_Biodata", new { area = "Admin" });
        }
    }
}